...
a) Discusión de las lecturas “teóricas” en formato seminario tipo alemán en donde se recomienda que escriban aproximadamente media página sobre sus evocaciones a propósito de la lectura y los temas de discusión que cada quien estime relevantes dentro del curso.



b) La lectura de textos de manual destinados al aprendizaje de las técnicas de la estadística para su aplicabilidad en la investigación y su realización en el lenguaje de programación R.



c) La exposición a la clase de al menos 2 lecturas (por persona) en dos cortes de notas diferentes de las lecturas propuestas como “opcionales” más abajo en el programa que se componen de estudios empíricos recientes que hacen uso de métodos cuantitativos (si quieren proponer algún estudio que esté más acorde a sus intereses por favor díganlo con tiempo).



d) El desarrollo de talleres de corte que serán espacios durante la clase destinados a la utilización de las herramientas in situ ya sea sobre *datasets* entregados por el docente o los *datasets* que irán construyendo a lo largo del semestre.



e) La presentación de una pequeña investigación conducida durante el curso y que deberá aplicar insumos tanto teóricos como técnicos vistos durante el semestre.

Sean estas actividades individuales o colectivas, intentaremos hacer del curso un foro de discusión, retroalimentación y aprendizaje mutuo de la mano del respeto y el cuidado pues de ello depende hacer un ambiente propicio para el aprendizaje y la colaboración.
...
Cada sesión se compone de tres espacios co-extensivos: lecturas teóricas de discusión crítica y colectiva, lecturas técnicas que complementan la presentación temática durante la clase por parte del docente y artículos de investigación que expondrán las(os) estudiantes durante el semestre (cada quién 2 veces en 2 cortes distintos) en donde serán ayudados(as) por sus compañeras(os) y el docente en la interpretación de datos e información que quieren compartir las investigaciones. Este último se plantea no como una responsabilidad de enseñanza de un artículo por parte de los(as) estudiantes sino como un espacio de inmersión en la práctica sociológica que todas y todos debemos complementar y compartir; además de ser una gran oportunidad para practicar nuestras habilidades y comunicación hablada. Recomiendo que no vean las exposiciones como una exposición cualquiera sino el momento en que pueden compartir, comunicar y explorar formas de uso actual de los métodos en donde todo el curso tiene la responsabilidad de participar activamente y complementar la exposición de estas lecturas opcionales.

De igual forma, nos iremos adentrando en el uso del lenguaje de programación R con el IDE RStudio para aprender la forma en que se despliegan estas técnicas a día de hoy a la par de aprender de qué se tratan.
...
El tiempo de preparación previa es poco, pero sugiero una breve inmersión o indagación acerca de R y RStudio como herramienta estadística crucial.



Mis recomendaciones:

[¿Debería aprender R? R en 2 minutos](https://youtu.be/7RkkE35ZMnE?si=R9RvzPb1udgO1kQ5)
...
* Timmermans, S \& Epstein, S. (2010). A World of Standards but not a Standard World: Toward a Sociology of Standards and Standardization\*. Annual Review of Sociology 36, 69-89. [https://doi.org/10.1146/annurev.soc.012809.102629](https://doi.org/10.1146/annurev.soc.012809.102629)
...
* Schwemmer, C., \& Wieczorek, O. (2020). The Methodological Divide of Sociology: Evidence from Two Decades of Journal Publications. Sociology, 54(1), 3–21. [https://doi.org/10.1177/0038038519853146](https://doi.org/10.1177/0038038519853146)
* Conwell, J. A., \& Loughran, K. (2024). Quantitative Inquiry in the Early Sociology of W. E. B. Du Bois. Du Bois Review: Social Science Research on Race, 21(2), 368–390. [https://doi.org/10.1017/S1742058X23000206](https://doi.org/10.1017/S1742058X23000206)
...
Materiales para instalación RStudio
...
[https://cran.r-project.org/doc/contrib/R-intro-1.1.0-espanol.1.pdf](https://cran.r-project.org/doc/contrib/R-intro-1.1.0-espanol.1.pdf)

[https://es.coursera.org/learn/intro-data-science-programacion-estadistica-r#syllabus](https://es.coursera.org/learn/intro-data-science-programacion-estadistica-r#syllabus)

* Llaudet, E. \& Imai, K. (2023). 1 Introduction. In Data Analysis for Social Science. A Friendly and Practical Introduction. Princeton University Press. pp. 1-26.
...
* Boyle, E. H., Kim, M., \& Longhofer, W. (2015). Abortion Liberalization in World Society, 1960-2009. American journal of sociology, 121(3), 882–913. [https://doi.org/10.1086/682827](https://doi.org/10.1086/682827)
* Glavin, P., Schieman, S., \& Wilson, A. (2026). The Self-Other Gap in Perceived Automation Risk: Evidence from the United States and Canada. Socius: Sociological Research for a Dynamic World, 12. [https://doi.org/10.1177/23780231261453968](https://doi.org/10.1177/23780231261453968)
...
* Aradhya, S., Grotti, R., \& Nieuwenhuis, R. (2026). Group Differences in Income Distributions, Poverty Gaps, and Poverty Buffers: Inequalities between the Children of Swedish-Born and Migrant Parents. Socius: Sociological Research for a Dynamic World, 12. [https://doi.org/10.1177/23780231261450748](https://doi.org/10.1177/23780231261450748)
* Tom, J. C., Ferguson, T. W., \& Martinez, B. C. (2025). Religion and Racial Bias in Artificial Intelligence Large Language Models. Socius: Sociological Research for a Dynamic World, 11. [https://doi.org/10.1177/23780231251377210](https://doi.org/10.1177/23780231251377210)



Tutorial:

[https://rawgraphs.io/learning/](https://rawgraphs.io/learning/)
...
* Lada A. A. \& Glance, N. 2005. The political blogosphere and the 2004 U.S. election: divided they blog. In Proceedings of the 3rd international workshop on Link discovery, 36–43. [https://doi.org/10.1145/1134271.1134277](https://doi.org/10.1145/1134271.1134277)
...
* Llaudet, E. \& Imai, K. (2023). 6 Probability. In Data Analysis for Social Science. A Friendly and Practical Introduction. Princeton University Press. pp. 162-195.
* Walpole, R. E., Myers, R. H., Myers, S. L., \& Ye, K. (2012). Estadística bayesiana. En Probabilidad y estadística para ingeniería y ciencias. Pearson. pp. 709-720.

Lecturas opcionales:

* Ma, X. (2026). On the Deep, Surprising, and Persistently Gendered Dynamics in Complex Music Tastes. Socius: Sociological Research for a Dynamic World, 12. [https://doi.org/10.1177/23780231251410969](https://doi.org/10.1177/23780231251410969)
...
* Imai, K. (2017). 7 Uncertainty. In Quantitative Social Science. Princeton University Press. pp. 314-369. PRINCIPALMENTE HYPOTHESIS TESTING pp. 342-369
...
* Waldman, K. E. (2025). Counting Race, Miscounting Identity: The Census and Hispanic Racial Self-Identification. Socius: Sociological Research for a Dynamic World, 11. [https://doi.org/10.1177/23780231251401662](https://doi.org/10.1177/23780231251401662)
...
Lectura opcional (esta tiene puntos extra):

* Munster, A., Tan, K. \& MacKenzie, A., (2021) “Images of the arXiv: Reconfiguring large scientific image datasets”, Journal of Cultural Analytics 6(1). [https://doi.org/10.22148/001c.21374](https://doi.org/10.22148/001c.21374)
